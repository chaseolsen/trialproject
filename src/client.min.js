...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Layout = function (_React$Component) {
	  ...
	  _createClass(Layout, [{
	    ...
	    key: 'handleMoreContent',
	    value: function handleMoreContent(e) {
	      var _this3 = this;

	      e.preventDefault();
	      _axios2.default.get('/moreposts').then(function (res) {
	        _this3.setState({
	          hidebtn: 'hidebtn',
	          posts: [].concat(_toConsumableArray(_this3.state.posts.concat(res.data)))
	        });
	      });
	    }
	  }, {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.posts.map(function (post) {
	            return _react2.default.createElement(
	              'div',
	              { key: post.title, className: 'post-container' },
	              _react2.default.createElement('img', { className: 'post-image', src: post.image }),
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  'a',
	                  { className: 'post-link', href: post.link },
	                  _react2.default.createElement(
	                    'h4',
	                    { className: 'post-link-text' },
	                    'Read More'
	                  )
	                )
	              )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: this.handleMoreContent.bind(this), className: "button-load-more " + this.state.hidebtn },
	            'LOAD MORE STORIES'
	          )
	        ),
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "button",
	                { type: "button", className: "navbar-toggle collapsed", "data-toggle": "collapse", "data-target": "#navbar3" },
	                _react2.default.createElement(
	                  "span",
	                  { className: "sr-only" },
	                  "Toggle navigation"
	                ),
	                _react2.default.createElement("span", { className: "icon-bar hamburger-bg" }),
	                _react2.default.createElement("span", { className: "icon-bar hamburger-bg" }),
	                _react2.default.createElement("span", { className: "icon-bar hamburger-bg" })
	              ),
	              _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "div",
	              { id: "navbar3", className: "navbar-collapse collapse" },
	              _react2.default.createElement(
	                "ul",
	...
	var Footer = function (_React$Component) {
	  ...
	  _createClass(Footer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "col-md-12 bottom-divider" },
	        _react2.default.createElement("img", { src: "../../images/Divider.png" }),
	        _react2.default.createElement(
	          "div",
	          { className: "bottom-disclaimer" },
	          _react2.default.createElement(
	            "h4",
	            null,
	            "\xA9 2017 Tenth Muse Design Inc. | Proudly Powered by Wordpress"
	          )
	        )
	      );
	    }
